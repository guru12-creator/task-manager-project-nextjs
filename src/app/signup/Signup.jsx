        ...
        <div className="py-5">
          ...
          <form action="#!" className="mt-5" onSubmit={doSignup}>
            ...
            <div className="mt-3">
              ...
              <input
                type="text"
                className="w-full p-3 text-white rounded-2xl bg-gray-800 focus:ring-gray-400-100 border border-gray-800"
                placeholder="Name"
                name="user_name"
                onChange={(event) => {
                  setData({
            ...
            <div className="mt-3">
              ...
              <input
                type="password"
                className="w-full p-3 rounded-2xl text-white bg-gray-800 focus:ring-gray-400-100 border border-gray-800"
